...
$reg_exp = "/^[a-z][a-z0-9]+$/iu"; // регулярное выражение - шаблон, с которым идет сравнение
$userStr = 'ivan123'; // Строка от пользователя


if (preg_match($reg_exp, $userStr)) {
...
<!--SELECT *-->
<!--FROM items-->
<!--WHERE description LIKE '%рубашка%';-->