			...
			<div class="row">
                ...
                <?php foreach($news_list as $news_item):?>
                    <div class="col-lg-4 mb-4">
                        <div class="entry2">
                            <a href="single.html"><img src="<?=$news_item['news_image']?>" alt="Image" class="img-fluid rounded"></a>
                            <div class="excerpt">
                                <span class="post-category text-white bg-secondary mb-3"><?=$news_item['category']?></span>

                                <h2><a href="single.html"><?=$news_item['title']?></a></h2>
